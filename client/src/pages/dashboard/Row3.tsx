...
import {useGetKpisQuery, useGetProductsQuery, useGetTransactionsQuery} from "@/state/api2";
...
const Row3 = () => {
  ...
  // even if we are using useGetKpisQuery again ang again but the api call is made only once. The redux toolKit is taking care of it.
